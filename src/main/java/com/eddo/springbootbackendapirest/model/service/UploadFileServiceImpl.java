...
public class UploadFileServiceImpl implements IUploadFileService{
    ...
    private final String DIRECTORIO_UPLOAD = "/Users/Eddo/Documents/uploads";
    ...
    public boolean eliminar(String nombreFoto) {
        if (nombreFoto != null && nombreFoto.length()>0){
            Path rutaFotoAnterior = Paths.get("/Users/Eddo/Documents/uploads").resolve(nombreFoto).toAbsolutePath();
